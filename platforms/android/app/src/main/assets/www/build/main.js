...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_signin_signin__ = __webpack_require__(93);
...
var AuthProvider = /** @class */ (function () {
    function AuthProvider(angularFireAuth, fb, platform, storage) {
            ...
            if (_this.platform.is("cordova")) {
                return _this.fb.login(["email", "public_profile"]).then(function (res) {
                    ...
                    _this.angularFireAuth.auth
                        ...
                        .then(function () {
                        _this.storage.set("user", { user: res.authResponse.accessToken });
                        observer.next();
                    })
                        .catch(function (error) {
                        //console.log(error);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_auth_auth__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__signin_signin__ = __webpack_require__(93);
...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, navParams, authProvider, fb, storage, loadingCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.authProvider = authProvider;
        this.fb = fb;
    ...
    HomePage.prototype.showFeeds = function () {
        var _this = this;
        ...
        this.fb
            ...
            var facebookString = _this.user_id + "/feed/?fields=id" + "&method=post" + "&link=" + _this.link;
            if (_this.post.facebook_message != null &&
                _this.post.facebook_message != "") {
                facebookString += "&message=" + _this.post.facebook_message;
            }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_signin_signin__ = __webpack_require__(93);
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* Platform */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_status_bar__["a" /* StatusBar */], __WEBPACK_IMPORTED_MODULE_3__ionic_native_splash_screen__["a" /* SplashScreen */], __WEBPACK_IMPORTED_MODULE_6_angularfire2_auth__["AngularFireAuth"]])
    ], MyApp);
    return MyApp;
}());
